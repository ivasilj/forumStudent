            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="exampleFormControlSelect1" class="col-md-4 col-form-label text-md-right">Izaberite fakultet</label>
                            <div class="col-md-6">
                                <select name ="college_id" class="form-control" id="exampleFormControlSelect1">
